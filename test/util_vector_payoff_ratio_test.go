...
func TestPayoffRatio(t *testing.T) {
	result1 := dataframe.PayoffRatio((dataframe.Vector{1, 2, 3}))
	...
	result2 := dataframe.PayoffRatio(dataframe.Vector{-1, -2, -3})
	...
	result3 := dataframe.PayoffRatio(dataframe.Vector{2, -1})
	...
	result4 := dataframe.PayoffRatio(dataframe.Vector{1, 1, -1})
